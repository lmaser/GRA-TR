...
- **Sub-labels**: Click the text next to MIDI to open the MIDI prompt (`CHANNEL` + `DELAY`). Right-click `AUTO` or `TRG` to open their capture/trigger delay prompts (`DELAY`).
